        ...
        <section id="media" className="space-y-4">
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <img src="https://upload.wikimedia.org/wikipedia/commons/a/ac/Button_dripper.JPG" alt="Drip irrigation system in a field" className="w-full h-96 rounded-lg shadow-md" />
              <img src="https://t3.ftcdn.net/jpg/04/26/36/04/360_F_426360432_3l6hp8dQDqHPR67JWIqfDJjTZTQSshwm.jpg" alt="Close-up of drip emitter" className="w-full h-96 rounded-lg shadow-md" />
            </div>
          </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <video src="video4.mp4" controls className="w-full h-96 rounded-lg shadow-md">
                Your browser does not support the video tag.
              </video>
              <video src="video3.mp4" controls className="w-full h-96 rounded-lg shadow-md">
                Your browser does not support the video tag.
              </video>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="list-disc space-y-4 pl-5">
              <li className='flex items-center bg-gray-100 w-fit p-4 rounded-xl'>
                <FileText className="mr-2" />
                <a href="#" className="text-blue-500 hover:underline">Drip Irrigation Design Guide</a>
              </li>
              <li className='flex items-center bg-gray-100 w-fit p-4 rounded-xl'>
                <FileText className="mr-2" />
                <a href="#" className="text-blue-500 hover:underline">Water Saving Techniques in Agriculture</a>
              </li>
            </ul>
          </div>
